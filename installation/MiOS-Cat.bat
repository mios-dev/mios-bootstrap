...
echo        %~dp0..\cat\autounattend\  or  C:\mios-bootstrap\cat\autounattend\
...
set "prov_ps="
if exist "%~dp0..\cat\autounattend\Invoke-MiOSProvision.ps1" set "prov_ps=%~dp0..\cat\autounattend\Invoke-MiOSProvision.ps1"
...
if /i not "%confirm%"=="Y" goto sub_deploy
set "dep_ps="
if exist "%~dp0..\cat\autounattend\Deploy-MiOSXbox.ps1" set "dep_ps=%~dp0..\cat\autounattend\Deploy-MiOSXbox.ps1"
...
:manual_docs
set "docs_dir="
if exist "%~dp0..\cat\autounattend\docs" set "docs_dir=%~dp0..\cat\autounattend\docs"
