...
# Usage: irm https://raw.githubusercontent.com/MiOS-FSS/MiOS-bootstrap/main/bootstrap-v2.ps1 | iex
...
$PublicInstaller = "https://raw.githubusercontent.com/MiOS-FSS/MiOS-bootstrap/main/mios-build-local.ps1"
...
try {
    ...
    Write-Host "    git clone https://github.com/mios-fss/MiOS-bootstrap.git" -ForegroundColor Gray
